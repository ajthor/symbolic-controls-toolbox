...
TEST_CASE("Kernel: dot gramian", "[kernel]") {
  std::vector<int> x = {1, 2};
  std::vector<int> y = {3, 4};

  Controls::DotKernel<int> k;
...
TEST_CASE("Kernel: polynomial gramian", "[kernel]") {
  std::vector<int> x = {1, 2};
  std::vector<int> y = {3, 4};

  Controls::PolynomialKernel<int> k(1, 0, 2);
...
TEST_CASE("Kernel: gaussian gramian", "[kernel]") {
  std::vector<int> x = {1, 2};
  std::vector<int> y = {3, 4};

  Controls::GaussianKernel<int> k(2);
  ...
  Controls::DenseMatrix<int> X(3, 2, {1, 2, 3, 4, 5, 6});
