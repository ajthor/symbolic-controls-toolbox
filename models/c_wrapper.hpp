...
CTRL_EXPORT void statespace_states_get(StateSpace_C* obj, size_t n, CVecBasic result);
CTRL_EXPORT void statespace_states_set(StateSpace_C* obj, size_t n, const CVecBasic arg);
...
CTRL_EXPORT void statespace_inputs_get(StateSpace_C* obj, size_t n, CVecBasic result);
CTRL_EXPORT void statespace_inputs_set(StateSpace_C* obj, size_t n, const CVecBasic arg);
...
CTRL_EXPORT void statespace_f_get(StateSpace_C* obj, size_t n, CVecBasic result);
CTRL_EXPORT void statespace_f_set(StateSpace_C* obj, size_t n, const CVecBasic arg);
...
CTRL_EXPORT void statespace_g_get(StateSpace_C* obj, size_t n, CVecBasic result);
CTRL_EXPORT void statespace_g_set(StateSpace_C* obj, size_t n, const CVecBasic arg);
