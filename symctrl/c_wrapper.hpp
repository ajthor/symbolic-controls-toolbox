...
SYMCTRL_EXPORT void mdp_probabilities_set(MDP_C *obj,
                                       size_t u,
                                       size_t x,
                                       size_t xp,
                                       const double arg);
SYMCTRL_EXPORT double mdp_probabilities_get(MDP_C *obj,
                                         size_t u,
                                         size_t x,
                                         size_t xp);
...
SYMCTRL_EXPORT void mdp_rewards_set(MDP_C *obj,
                                 size_t u,
                                 size_t x,
                                 size_t xp,
                                 const double arg);
SYMCTRL_EXPORT double mdp_rewards_get(MDP_C *obj,
                                   size_t u,
                                   size_t x,
                                   size_t xp);
