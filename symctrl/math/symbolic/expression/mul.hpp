...
//
template<typename T1, typename T2>
inline ExprMul<Symbolic, T1, T2>::ExprMul(const T1 &lhs,
                                          const T2 &rhs) :
                                          lhs_(lhs),
                                          rhs_(rhs) {
  //
...
template<typename T1, typename T2>
inline ExprMul<Symbolic, T1, T2>::ExprMul(const ExprMul<Symbolic, T1, T2> &m) :
                                          lhs_(m.lhs_),
                                          rhs_(m.rhs_) {
  //
}
...
//
template<typename T1, typename T2>
inline const ExprMul<Symbolic, T1, T2>
