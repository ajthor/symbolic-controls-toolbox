#ifndef SYMCTRL_MATH_MATRIX_EXPRESSION_SYMBOLIC_HPP
#define SYMCTRL_MATH_MATRIX_EXPRESSION_SYMBOLIC_HPP
...
#endif /* end of include guard: SYMCTRL_MATH_MATRIX_EXPRESSION_SYMBOLIC_HPP */
