#ifndef MATH_MATRIX_EXPRESSION_VECTOR_HPP
#define MATH_MATRIX_EXPRESSION_VECTOR_HPP

#include <math/matrix/vector/vector.hpp>
#include <math/matrix/expression/symbolic.hpp>
...
inline void SymbolicVector::apply_add(const Matrix<SymbolicVector> &rhs) {
  MATH_ASSERT(n_ == (~rhs).n_);
  MATH_ASSERT(m_ == (~rhs).m_);
...
#endif /* end of include guard: MATH_MATRIX_EXPRESSION_VECTOR_HPP */
