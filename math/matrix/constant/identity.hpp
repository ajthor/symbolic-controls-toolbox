#ifndef MATH_MATRIX_CONSTANT_IDENTITY_HPP
#define MATH_MATRIX_CONSTANT_IDENTITY_HPP
...
template<size_t N, size_t M>
inline DenseMatrix<RCPBasic> Identity<RCPBasic, N, M>::as_dense() const {
...
#endif /* end of include guard: MATH_MATRIX_CONSTANT_IDENTITY_HPP */
